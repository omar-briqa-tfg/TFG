...
\noindent \\
\textit{Grafana Labs} proporciona \textit{Loki}, un sistema d’agregació codi obert de \textit{\gls{log}s} basat en Prometheus.
...
\begin{itemize}
    \item \textbf{Escalabilitat}: dissenyat per monitorar \textit{\gls{log}s} fins a una escala de petabytes
