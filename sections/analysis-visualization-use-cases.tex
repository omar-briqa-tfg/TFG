...
\begin{itemize}
    ...
    \item Podem veure com sempre el contingut del registre d'accés és correcte (content = “ok”) i el mètode utilitzat és el \texttt{GET}.
...
\begin{figure}[htbp]
    ...
    \captionsetup{justification=centering}
    \caption[Condicions d'accés dels accessos a recursos de l'EPSEVG el primer de desembre del 2023.]{Condicions d'accés dels accessos a recursos de l'EPSEVG el primer de desembre del 2023. (\textbf{Font}: Elaboració pròpia.)}\label{fig:log-altered}
\end{figure}
