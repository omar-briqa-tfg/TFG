...
\noindent \\
Extraurem la informació de les nostres bases de dades: \textit{InfuxDB} on es troben emmagatzemats els logs, i \textit{MongoDB} on hi són emmagatzemades les metadades dels recursos d'\gls{UPCommons}.
